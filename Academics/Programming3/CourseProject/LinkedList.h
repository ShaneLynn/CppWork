...
public:
	...
	void DisplayList();
	int CountNodes();						//Added function to count the nodes in a list
...
/******************************************************************
* This function traverses through the linkedlist nodes
* to and counts them.  It returns the total nodes found and is useful
* for loops.
******************************************************************/
template <class T>
